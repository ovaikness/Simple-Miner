...
{
	Vec3 pos0(bounds.m_min.x, bounds.m_min.y, 0.f);
	Vec3 pos1(bounds.m_max.x, bounds.m_min.y, 0.f);
	Vec3 pos2(bounds.m_max.x, bounds.m_max.y, 0.f);
	Vec3 pos3(bounds.m_min.x, bounds.m_max.y, 0.f);
